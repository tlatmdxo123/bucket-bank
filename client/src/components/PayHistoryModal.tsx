...
function PayHistoryModal({title,submitPayHistory,setModalActive}:PayHistoryModalPropsTypes) {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        submitPayHistory(content,payment)
    }
    return (
        <Modal>
            <form onSubmit={(e) => handleSubmit(e)} onKeyPress={(e) => onKeyPess(e)}>
